...
```
 ...
 EOF
```
- A `website` attribute defining `index_document = index.html`, and `error_document = error.html`
  website {
- tags: `var.tags`
...
Now that you have created your module, return to the `main.tf` in your root module and add a reference to the new module specifying: 
- module name
- module source
- bucket_name
- tags
...
- value: vpc module's public_subnets

- output: `ec2_instance_public_ips`
- description: "Public IP addresses of EC2 instances"
- value: ec2_instances module's public_ip

- output: `website_bucket_arn`
- description: "ARN of the bucket"
- value: website_s3 module's arn

- output: `website_bucket_name`
- description: "Name (id) of the bucket"
- value: website_s3 module's name

- output: `website_bucket_domain`
- description: "Domain name of the bucket"
- value: website_s3 module's domain
