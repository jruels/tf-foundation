...
- output variable `vpc_public_subnets`
- description: "IDs of the VPC's public subnets"
- value: refer to the `vpc` module's var `public_subnets`


- output variable `ec2_instance_public_ips`
- description: "Public IP addresses of EC2 instances"
- value: refer to the `ec2_instances` module's var `public_ip`
